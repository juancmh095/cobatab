...
$gbd->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
$gbd->beginTransaction();
$sentencia = $gbd->prepare("SELECT MAX(folio_cita) FROM citatorios;'");
$sentencia->execute();
$fila = $sentencia->fetch();
$folio=$fila['MAX(folio_cita)'];
$folio=$folio+1;
?>

<center>
<form name="form2" action="php/citatorios.php" method="post">
...
<br>
<label style="font-size:20px">Fecha de cita:</label>
<input type="date" name="fecha_cita" value="">
<br>
<label style="font-size:20px">Hora de la cita:</label>
<input type="text" name="hora" placeholder="Horario de cita">
<br>
<label style="font-size:20px">Maestro que solicita:</label>
<input type="text" name="maestro" placeholder="Maestro">
<br>
