...
<hr>
      <div class="starter-template">
        <h1>ALUMNO: <label><a href="alumnos1.php">Ver todos los alumnos</a></label></h1>
        <br>
...
<form action="" method="POST">
        <input name="usuario" max-length="20" placeholder="Matricula"/>
...
try {  
  ...
  $gbd->beginTransaction();
   $sentencia = $gbd->prepare("SELECT A.*, g.grado, gr.grupo from alumnos AS A, grado AS g, grupo AS gr WHERE A.matricula='$usuario' AND g.matricula_grado=A.matricula_grado AND gr.matricula_grupo=A.matricula_grupo");
